...
Production-grade implementation with performance optimization.
"""

from sqlalchemy import (
    Column, String, Integer, Boolean, DateTime, JSON, Text, ForeignKey,
...
class SchemaVersion(Base):
    ...
    __tablename__ = "oms_schema_versions"
...
class ObjectTypeDef(Base):
    ...
    __tablename__ = "oms_object_types"
    
    id = Column(Integer, primary_key=True, autoincrement=True)
    schema_version_id = Column(Integer, ForeignKey("oms_schema_versions.id"), nullable=False, index=True)
...
class PropertyDef(Base):
    ...
    __tablename__ = "oms_properties"
    
    id = Column(Integer, primary_key=True, autoincrement=True)
    object_type_id = Column(Integer, ForeignKey("oms_object_types.id"), nullable=False, index=True)
...
class ActionTypeDef(Base):
    ...
    __tablename__ = "oms_action_types"
...
class SecurityPolicy(Base):
    ...
    __tablename__ = "oms_security_policies"
...
class PolicyRule(Base):
    ...
    __tablename__ = "oms_policy_rules"
    
    id = Column(Integer, primary_key=True, autoincrement=True)
    policy_id = Column(Integer, ForeignKey("oms_security_policies.id"), nullable=False, index=True)
    
    role = Column(String(50), nullable=False, index=True)
    access_level = Column(String(50), nullable=False)
    scope = Column(String(50), nullable=True)
    
    column_filters = Column(JSON, nullable=True)
