...
import {
  ...
  TeamProfile,
  TeamPerformanceData,
  TeamMatchupHistory as MatchupData,
} from '../../../lib/profileApi'
...
export default function TeamProfilePage() {
  ...
  useEffect(() => {
    const loadData = async () => {
      setLoading(true)
      try {
        const [teamData, perfData, matchupData] = await Promise.all([
          getTeamProfile(teamId.toUpperCase()),
          getTeamPerformance(teamId.toUpperCase()),
          getTeamMatchups(teamId.toUpperCase()),
        ])
        setTeam(teamData)
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-4 xl:gap-6">
            ...
            <div className="lg:col-span-7 xl:col-span-7 space-y-6">
              ...
              >
                {tabs.map((tab) => (
                  <button
                    ...
                    className={`px-4 py-2 text-xs font-military-display uppercase tracking-widest transition-all duration-200 rounded-lg border ${
                      activeTab === tab.id
              ...
              <div className="space-y-6">
                ...
                {activeTab === 'matchups' && (
                  <TeamMatchupHistory matchups={matchups} />
                )}
                {activeTab === 'roster' && (
                  <motion.div
                    initial={{ opacity: 0, y: 20 }}
                  ...
                  >
                    ...
                    <div className="relative p-6 text-center">
                      <p className="text-sm font-military-display text-gray-400">
                        Roster composition visualization coming soon
                      </p>
                    </div>
                  </motion.div>
                )}
            ...
            <div className="lg:col-span-3 xl:col-span-3 space-y-6">
                ...
                <div className="relative p-6">
                  ...
                  <div className="space-y-3 text-sm font-military-display">
                    <div className="flex justify-between">
                      ...
                      <span className="text-blue-400 tabular-nums">{((team.record.points / ((team.record.wins + team.record.losses + team.record.otLosses) * 2)) * 100 || 0).toFixed(1)}%</span>
                    </div>
                    <div className="flex justify-between">
              ...
              >
                ...
                <div className="relative p-6 text-center">
                  <p className="text-sm font-military-display text-gray-400">
                    Additional graphs and matchup analytics coming soon
                  </p>
                </div>
              </motion.div>
            </div>
