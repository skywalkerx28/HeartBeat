    ...
    >
      ...
      <div className="relative overflow-hidden rounded-lg">
        ...
        <div className="relative p-4">
            ...
            <div className="text-xl font-mono text-white tracking-wider mb-3 tabular-nums">
              {player.playerId}
            </div>
            
            <h1 className="text-2xl font-military-display text-white uppercase tracking-wider mb-3">
              {player.lastName}
            </h1>
            
            <div className="text-base font-military-display text-gray-400 mb-3">
        ...
        <div className="relative p-4">
          ...
          <div className="space-y-3">
            ...
            <div className="flex items-center justify-between pt-2 border-t border-white/10">
              ...
              <span className="text-lg font-military-display text-blue-400 tabular-nums">
        ...
        <div className="relative p-4">
          ...
          <div className="space-y-3">
            ...
            <div className="flex items-center justify-between">
              ...
              <span className="text-sm font-military-display text-blue-400 uppercase tracking-wider">
