    ...
    <div className="relative group overflow-hidden rounded-lg">
      ...
      <div className="relative p-5">
        ...
        <div className="grid grid-cols-[30px_1fr_45px_70px_45px_50px] gap-3 px-2 pb-2 border-b border-white/10 mb-2">
          <div className="text-[9px] font-military-display text-gray-500 uppercase tracking-wider">#</div>
          <div className="text-[9px] font-military-display text-gray-500 uppercase tracking-wider">Team</div>
          <div className="text-[9px] font-military-display text-gray-500 uppercase tracking-wider text-center">GP</div>
          <div className="text-[9px] font-military-display text-gray-500 uppercase tracking-wider text-center">Last 5</div>
          <div className="text-[9px] font-military-display text-gray-500 uppercase tracking-wider text-center">SI</div>
          <div className="text-[9px] font-military-display text-gray-500 uppercase tracking-wider text-right">PTS</div>
        </div>
          ...
          {atlanticTeams.slice(0, 8).map((team, index) => {
            ...
            return (
              <motion.div
                ...
                className="grid grid-cols-[30px_1fr_45px_70px_45px_50px] gap-3 items-center p-2 rounded border transition-all duration-200 bg-white/[0.02] border-white/5 hover:bg-white/5 hover:border-white/10"
              >
                {/* Rank */}
                ...
                {/* Points */}
                <div className={`text-sm font-military-display ${isMTL ? 'text-white' : 'text-gray-300'} text-right tabular-nums`}>
                  {points}
                </div>
              </motion.div>
            )
